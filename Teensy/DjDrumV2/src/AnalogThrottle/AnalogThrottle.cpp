...
AnalogThrottle::AnalogThrottle(int pin):
    previousDuration(0),
    isRisen(false),
    isFallen(false),
    debounceTimeMillis(50),
...
AnalogThrottle::AnalogThrottle(int pin, uint16_t interval_millis):
    previousDuration(0),
    isRisen(false),
    isFallen(false),
    debounceTimeMillis(50),
...
AnalogThrottle::AnalogThrottle(int pin, uint16_t interval_millis, int threshold):
    previousDuration(0),
    isRisen(false),
    isFallen(false),
    debounceTimeMillis(50),
